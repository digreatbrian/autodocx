...
from autodocx.contrib.utils import ItemData, WarningSubtypes
...
class AutodocObject(SphinxDirective):
    ...
    def run(self) -> list[nodes.Node]:
        ...
        if full_name not in autodocx_db:
            warn_sphinx(
        ...
        mod_parent = None
        class_parent = None
        for ancestor in autodocx_db.get_ancestors(full_name, include_self=True):
            if ancestor is None:
