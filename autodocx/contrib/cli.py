...
from autodocx.autodocx import __name__ as package_name
from autodocx.autodocx import __version__
from autodocx.autodocx.analysis import analyse_module
from autodocx.autodocx.config import Config
from autodocx.autodocx.db import InMemoryDb, UniqueError
from autodocx.autodocx.resolve_all import AllResolver
from autodocx.autodocx.utils import WarningSubtypes, yield_modules
...
def main_app(
    ...
    """
    [underline]CLI for autodocx[/underline]
    """
    pass
