...
def analyse_module(
    file_path: Path,
    name: str,
    exclude_external_imports: t.Pattern[str] | None = None,
) -> t.Iterable[ItemData]:
    """
    Analyse the given module and yield items.
    
    Args:
        file_path (Path): The path to the module.
        name (str): The name of the module, e.g. "foo.bar".
        record_external_imports (str): If given, record these external imports on the module.
    ...
    node = builder.file_build(str(file_path), name)    
